...
namespace FAST.FBasicInterpreter
{
    public partial class FBasic2DArrays  : IFBasicLibrary
    {
        ...
        private void JaggedArrayDim(Interpreter interpreter)
        {
            //
        ...
        private void ColumnName(Interpreter interpreter)
        {
            //
        ...
        private void ColumnAddName(Interpreter interpreter)
        {
            //
        ...
        private void IndexDelete(Interpreter interpreter)
        {
            //
        ...
        private Value ColumnNamesCount(Interpreter interpreter, List<Value> args)
        {
